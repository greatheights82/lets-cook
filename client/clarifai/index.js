...
export const clarifaiApp = new Clarifai.App({
  apiKey: '069199cca64043b8b7b7b968967aad16',
})
  ...
  outputs: [
    {
      ...
      input: {
        ...
        data: {
          image: {
            url:
              'https://s3.amazonaws.com/clarifai-api/img/prod/b749af061d564b829fb816215f6dc832/e11c81745d6d42a78ef712236023df1c.jpeg',
          },
        },
      },
      data: {
